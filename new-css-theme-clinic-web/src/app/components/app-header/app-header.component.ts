...
import { ConsultationPatientInfoComponent } from './../consultation/consultation-patient-info/consultation-patient-info.component';
    ...
    const subscribe = source.subscribe(val => {
      if(this.store.getUserId())
      {
        this.apiPatientInfoService.searchBy('systemuserid', this.store.getPatientId()).subscribe(
          // this.apiPatientInfoService.searchBy('systemuserid', '5b55b8490550de0021688e34').subscribe(
