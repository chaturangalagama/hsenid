...
export class PatientDetailComponent implements OnInit {
  ...
  @Input() allowEdit: Subject<boolean>;
  ...
  getPatientInfo(){
    if (this.store.getPatientId()) {
      ...
      // Get Patient Details
        ...
        this.patientDetailFormGroup.disable();
        
        this.allowEdit.subscribe( value =>{
          if(value){
            this.patientDetailFormGroup.enable();
          }else{
            this.patientDetailFormGroup.disable();
          }
        });
  ...
  subscribeValueChanges() {
    ...
    this.patientDetailFormGroup
      ...
      .subscribe(values => {
        ...
        this.patientDetailFormGroup.get('basicInfoFormGroup').get('primary').markAsTouched();
        this.patientDetailFormGroup.get('basicInfoFormGroup').get('secondary').markAsTouched();
        ...
        patientInfo.consentGiven = values.consentGiven;
