...
// import { Clinic } from '../../bussiness/objects/response/Clinic';
...
// import { AllergyGroup } from '../../bussiness/objects/response/AllergyGroup';
// import { PatientRegistryListResponse } from '../../bussiness/objects/response/PatientRegistryListResponse';
import { AuthService } from './auth.service';
import { User } from '../objects/User';
// import { MedicalTest } from '../../bussiness/objects/response/MedicalTestListAll';
// import { DrugItem, Instruction, DosageInstruction } from '../../bussiness/objects/DrugItem';
// import { Uom } from '../../bussiness/objects/Uom';
// import { MedicalCoverageSelected } from '../../bussiness/objects/MedicalCoverage';
// import { MedicalServiceResponse } from '../../bussiness/objects/response/MedicalServiceResponse';
// import { Vaccine } from '../../bussiness/objects/response/VaccinationList';
...
export class StoreService implements OnDestroy {
  ...
  private user: User;
  medicalCoverageList: Array<any> = [];
  medicalCoverageListWithExpired: Array<any> = [];
  visitPurposeList = [];
  ...
  doctorListByClinic = [];
  clinicId: string;
  clinicCode: string = 'OUB';
  clinic;
  medicalServiceList: any[] = [];
  drugList: any[] = [];
  vaccinationList: any[] = [];
  medicalTestList: any[] = [];
  chargeItemList = [];
