...
import { UserLogin } from '../../../../bussiness/objects/User';
...
export class LoginComponent implements OnInit, OnDestroy {
  ...
  constructor(private router: Router, private authService: AuthService, private alertService: AlertService, private storeService: StoreService, 
