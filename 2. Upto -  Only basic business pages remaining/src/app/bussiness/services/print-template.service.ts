...
import { drugLabelTemplate } from '../templates/drug.label';
import { patientLabelTemplate } from '../templates/patient.label';
import { medicalCertificateTemplate } from '../templates/medical.certificate';
import { memoTemplate } from '../templates/memo';
import { vaccinationCertificateTemplate } from '../templates/vaccination.certificate';
import { timeChitTemplate } from '../templates/time.chit';
import { NgxPermissionsService } from 'ngx-permissions';
import { DISPLAY_DATE_FORMAT, DB_FULL_DATE_FORMAT } from '../../core/constants/app.constants';

import { Injectable } from '@angular/core';

import { ApiPatientVisitService } from '../components/views/patient/services/api-patient-visit.service';
import { AlertService } from '../../core/services/alert.service';
import { ApiCmsManagementService } from '../components/views/consultation/services/api-cms-management.service';
import { PaymentService } from '../components/views/payment/services/payment.service';
import { StoreService } from '../../core/services/store.service';

import * as moment from 'moment';
import { refferalLetterTemplate } from '../templates/refferal.letter';
