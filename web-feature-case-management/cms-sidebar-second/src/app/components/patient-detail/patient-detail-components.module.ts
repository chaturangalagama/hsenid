...
import { PatientDetailMedicalCoverageComponent } from './patient-detail-medical-coverage/patient-detail-medical-coverage.component';
...
import { PatientDetailMedicalCoverageItemComponent } from './patient-detail-medical-coverage/patient-detail-medical-coverage-item/patient-detail-medical-coverage-item.component';
...
@NgModule({
  ...
  exports: [
    ...
    PatientDetailMedicalCoverageItemComponent,
